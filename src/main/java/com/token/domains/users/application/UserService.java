    ...
    UsersEntity usersEntity =
        usersRepository.save(
            UsersEntity.builder()
                    ...
                    .age(userRequest.getUserage())
                    .area(userRequest.getUserarea())
                    .school(userRequest.getUserschool())
                    .blood(userRequest.getUserblood())
                    .foot_size(userRequest.getUserfoot_size())
